Mobility.configure do
  ...
  plugins do
    ...
    # Fallbacks
    #
    # Falls back to French if EN or NL translation is missing.
    fallbacks({ en: :fr, nl: :fr })
    ...
    # Locale Accessors
    #
    # Generates job_title_fr, job_title_en, job_title_nl etc.
    locale_accessors [:fr, :en, :nl]
